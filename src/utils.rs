...
#[inline]
pub unsafe fn detach_lifetime_ref<'this, R: ?Sized>(v: <R as RefDef<'_>>::Type) -> <R as RefDef<'this>>::Type
where
    for<'a> R: RefDef<'a>,
...
#[inline]
pub unsafe fn detach_lifetime_pin<'this, R: ?Sized>(v: Pin<&mut <R as RefDef<'_>>::Type>) -> Pin<&'this mut <R as RefDef<'this>>::Type>
where
    for<'a> R: RefDef<'a>
{
    mem::transmute(v)
